...
<script type="text/javascript">
    ...
    var yAxisMax = Math.ceil(maxExpense / 25) * 25; // Menyesuaikan nilai maksimum sumbu Y ke kelipatan 25000 terdekat
    ...
    Highcharts.chart('chart', {
        ...
        yAxis: {
            ...
            tickInterval: 25, // Menetapkan interval sumbu Y menjadi 25000
